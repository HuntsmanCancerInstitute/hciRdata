...
#' # Download version 87
#  mmu87 <- read_biomart("mouse", version = 87)
...
read_biomart_version <- function( dataset="human", attributes, version = NULL, list = NULL, ...){
   ...
   if(!is.null(list)){
      ...
      if(missing(attributes)){
          bm <- biomaRt::getBM(attributes=c('ensembl_gene_id','external_gene_name', 'gene_biotype',
           ...
           names(bm)[c(1:6,9)] <- c("id", "gene_name", "biotype", "chromosome", "start", "end", "transcripts")
